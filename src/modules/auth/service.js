...
import { sendVerificationEmail, sendPasswordResetEmail, sendWelcomeEmail, sendNewDeviceEmail } from "../../lib/email";
...
export const authService = {
    ...
    async signin(input, ip, userAgent) {
        const emailLower = input.email.toLowerCase().trim();
    ...
    async refreshAccessToken(refreshTokenValue, ip, userAgent) {
