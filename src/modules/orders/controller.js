...
export const ordersController = {
    async createOrder(req, res) {
        ...
        const result = await ordersService.createOrderFromCart(userId, req.body, publicUser);
        res.status(201).json({
    ...
    async updateOrderStatus(req, res) {
        ...
        const id = typeof req.params.id === "string" ? req.params.id : "";
        const order = await ordersService.updateOrderStatus(id, req.body, userRole);
        res.json({
    ...
    async cancelOrder(req, res) {
        ...
        const id = typeof req.params.id === "string" ? req.params.id : "";
        const order = await ordersService.cancelOrder(id, req.body, userId, userRole);
        res.json({
