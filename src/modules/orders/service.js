...
export const ordersService = {
    async createOrderFromCart(userId, input, user) {
        // Get user's cart
    ...
    async listOrders(options) {
        ...
        if (options.paymentStatus) {
            listOptions.paymentStatus = options.paymentStatus;
        }
        const countOptions = {};
        if (effectiveUserId) {
    ...
    async updateOrderStatus(id, input, userRole) {
    ...
    async cancelOrder(id, input, userId, userRole) {
    ...
    async verifyPayment(reference, userId, userRole) {
