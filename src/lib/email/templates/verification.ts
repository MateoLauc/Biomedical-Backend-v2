...
export type VerificationTemplateData = {
...
export function verificationHtml(data: VerificationTemplateData): string {
...
export function verificationText(data: VerificationTemplateData): string {
